...
const esquema = mongoose.Schema({
   ...
   livreiro: {
      ...
      ref: 'Livreiro', // Nome do model referenciado
      required: true
   }
})
...
esquema.plugin(mongooseSeq, {inc_field: 'num_compra', start_seq: 1});
...
module.exports = mongoose.model('Compra', esquema, 'compras')